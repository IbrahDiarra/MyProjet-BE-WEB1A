    ...
    if(isset($_POST['envoyer'])){
            ...
            if(isset($cours) && isset($etudiant) && isset($note) && isset($date)  && $cours != "" && $etudiant != "" && $note != "" && $date != ""  ){
                ...
                if($req){
                    ...
                    $_SESSION['messagenote'] = "La mise à jour effectuée avec succès !" ;
    ...
    <div class="card card-outline mb-5 card-info">
        <div class="card-header d-flex">
           <h3 class="card-title foot" style="font-size: 25px; color:blue;">Mise à jour</h3>
            <?php if(isset($_SESSION['messagenote'])):?>
                <div class='toast show'>
                    <div class='toast-header text-center'>
                        <strong class='me-auto text-dark text-center' style="font-family:'Patua One';"><?php echo $_SESSION['messagenote'] ;?></strong>
