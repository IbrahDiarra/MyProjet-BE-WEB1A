<?php 
    ...
    if(isset($_POST['envoyer'])){
            ...
            if(isset($lib) && isset($coef) && isset($enseignant)  && $lib != "" && $coef != "" && $enseignant != ""  ){
                // créons la question
                $resultat ="INSERT INTO cours (lib_cours, coef, id_enseignant) VALUES ('$libe','$coef','$enseignant')";

                $req = mysqli_query($con ,$resultat );
                if($req){
                    
                    $messagecours = "Le cours a été ajouté avec succès !" ;
                } else {
                    //si non
...
<section class="page-section">
    <div class="card card-outline mb-5 card-info">
        <div class="card-header d-flex">
            ...
            <?php if(isset($messagecours)):?>
                <div class='toast show'>
                    <div class='toast-header text-center'>
                        <strong class='me-auto text-dark text-center' style="font-family:'Patua One';"><?php echo $messagecours ;?></strong>
                ...
                <form action=""  method="POST" enctype="multipart/form-data" class="p-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 mb-3 mt-2 mb-sm-0">
                            <textarea name="libelle" id="libelle" cols="50" rows="2"  class="form-control form no-resize summernote"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="text-center col-sm-3 mb-3 mt-2 mb-sm-0 d-flex align-items-center">
                        ...
                        <div class="col-sm-9 mb-3 mt-2 mb-sm-0">
                             <input type="number" class="form-control form-control-user" name="coef">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="text-center col-sm-3 mb-3 mt-2 mb-sm-0 d-flex align-items-center">
                        ...
                        <div class="col-sm-9 mb-3 mt-2 mb-sm-0">
                            <input type="number" class="form-control form-control-user" name="enseignant">
                        </div>
                    </div>
