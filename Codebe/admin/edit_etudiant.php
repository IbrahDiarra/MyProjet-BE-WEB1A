              ...
              && $date != "" && $mdp1 != "" && isset($mdp2) && $mdp2 != "" && $nom != "" && $prenom != "" && $matricule != "" && $sexe != "" && $filiere != "" && $classe != ""){
               ...
               if($mdp2 != $mdp1){
                   ...
                   $error = "Les Mots de passes sont différents !";
                       ...
                       $resultat ="UPDATE `etudiant` SET Matricule='$matricule', Date_naissance='$date', Nom='$nom' , Prenom='$prenom' , mdp='$mdp1' , Photo='$nouveau_img_nom' , Sexe='$sexe', id_filiere='$filiere', id_classe='$classe'  WHERE id= '$id' ";
                       ...
                       if($req){
                           ...
                           echo "<script> window.location.href='index.php?page=voir_etudiant';</script>";
...
<section class="page-section">
           <div class="container bg-white mt-3" style="border-radius:15px;">
                <div class="row pt-3"  >
                    <div class=""><h3 class="ibtexte45" style="font-family: 'Lobster';">Editer les infos</h3></div>
