              ...
              && $date != "" && $mdp1 != "" && isset($mdp2) && $mdp2 != "" && $nom != "" && $prenom != "" && $matricule != "" && $sexe != "" && $filiere != "" && $classe != ""){
               ...
               if($mdp2 != $mdp1){
                   ...
                   $error = "Les Mots de passes sont différents !";
                       ...
                       $resultat ="UPDATE `etudiant` SET Matricule='$matricule', email='$email', Nom='$nom' , Prenom='$prenom' , mdp='$mdp1' , Photo='$nouveau_img_nom' , Sexe='$sexe', id_filiere='$filiere', id_classe='$classe'  WHERE Matricule= '$user' ";

                       $req = mysqli_query($con ,$resultat );
                       if($req){
                           // si le compte a été créer , créons une variable pour afficher un message dans la page de
                           //connexion
                           $_SESSION['message_et'] = "Mise à jour effectuée avec succès !" ;
                            ...
                            <div class="col-lg-9 bg-white" style="border-radius: 0px 20px 20px 0px;">
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-8">
                                            <?php if(isset($_SESSION['message_et'])):?>
                                                <div class='toast show'>
                                                    <div class='toast-header text-center'>
                                                        <strong class='me-auto text-dark text-center' style="font-family:'Patua One';"><?php echo $_SESSION['message_et'] ;?></strong>
